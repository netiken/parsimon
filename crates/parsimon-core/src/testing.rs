use crate::network::{
    topology::Topology,
    types::{Channel, Link, Node, NodeId},
};
use crate::TopologyError;

pub(crate) fn three_node_topology() -> Result<Topology<Channel>, TopologyError> {
    ...
    Topology::new(&[n1, n2, n3], &[l1, l2])
}

pub(crate) fn eight_node_topology() -> Result<Topology<Channel>, TopologyError> {
